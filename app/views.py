...
def induccion(request):
	if request.user.profile.permiso == '2':
		if request.user.profile.facultad == 'FECS':
			reports = Report.objects.filter(reporte_Departamento__in=['UNACH','FACS','ED_PARV','PED_BIO','PED_ED_DIF','PED_ED_FIS','PED_ED_GEN_BAS','PED_HIS','PED_ING','PED_LENG','PED_MAT','PED_MUS','TRAB_SOC'],tipo_reporte='Induccion').order_by('nombre')
		elif request.user.profile.facultad == 'FACS':
		...
		if request.user.profile.carrera == 'AGRO':
			...
			reports = Report.objects.filter(reporte_Departamento__in=['FAIN','UNACH','ED_PARV'], tipo_reporte='Induccion').order_by('nombre') 
		elif request.user.profile.carrera == 'ENF':
			reports = Report.objects.filter(reporte_Departamento__in=['FAIN','UNACH','ENF'], tipo_reporte='Induccion').order_by('nombre') 
		elif request.user.profile.carrera == 'ING_CIV_INF':
			...
			reports = Report.objects.filter(reporte_Departamento__in=['FAIN','UNACH','NUT'], tipo_reporte='Induccion').order_by('nombre') 
		elif request.user.profile.carrera == 'OBS':
			reports = Report.objects.filter(reporte_Departamento__in=['FAIN','UNACH','OBS'], tipo_reporte='Induccion').order_by('nombre')
		elif request.user.profile.carrera == 'PED_ED_DIF':
			reports = Report.objects.filter(reporte_Departamento__in=['FAIN','UNACH','PED_ED_DIF'], tipo_reporte='Induccion').order_by('nombre') 
		elif request.user.profile.carrera == 'PED_BIO':
			reports = Report.objects.filter(reporte_Departamento__in=['FAIN','UNACH','PED_BIO'], tipo_reporte='Induccion').order_by('nombre') 
		elif request.user.profile.carrera == 'PED_ED_FIS':
			reports = Report.objects.filter(reporte_Departamento__in=['FAIN','UNACH','PED_ED_FIS'], tipo_reporte='Induccion').order_by('nombre') 
		elif request.user.profile.carrera == 'PED_ED_GEN_BAS':
			reports = Report.objects.filter(reporte_Departamento__in=['FAIN','UNACH','PED_ED_GEN_BAS'], tipo_reporte='Induccion').order_by('nombre') 
		elif request.user.profile.carrera == 'PED_HIS':
			reports = Report.objects.filter(reporte_Departamento__in=['FAIN','UNACH','PED_HIS'], tipo_reporte='Induccion').order_by('nombre') 
		elif request.user.profile.carrera == 'PED_ING':
			reports = Report.objects.filter(reporte_Departamento__in=['FAIN','UNACH','PED_ING'], tipo_reporte='Induccion').order_by('nombre') 
		elif request.user.profile.carrera == 'PED_LENG':
			reports = Report.objects.filter(reporte_Departamento__in=['FAIN','UNACH','PED_LENG'], tipo_reporte='Induccion').order_by('nombre') 
		elif request.user.profile.carrera == 'PED_MAT':
			reports = Report.objects.filter(reporte_Departamento__in=['FAIN','UNACH','PED_MAT'], tipo_reporte='Induccion').order_by('nombre') 
		elif request.user.profile.carrera == 'PED_MUS':
			reports = Report.objects.filter(reporte_Departamento__in=['FAIN','UNACH','PED_MUS'], tipo_reporte='Induccion').order_by('nombre') 
		elif request.user.profile.carrera == 'PSICO':
			reports = Report.objects.filter(reporte_Departamento__in=['FAIN','UNACH','PSICO'], tipo_reporte='Induccion').order_by('nombre') 
		elif request.user.profile.carrera == 'TEO':
			reports = Report.objects.filter(reporte_Departamento__in=['FAIN','UNACH','TEO'], tipo_reporte='Induccion').order_by('nombre') 
		elif request.user.profile.carrera == 'TNS_ENF':
			reports = Report.objects.filter(reporte_Departamento__in=['FAIN','UNACH','TNS_ENF'], tipo_reporte='Induccion').order_by('nombre') 
		elif request.user.profile.carrera == 'TRAB_SOC':
			reports = Report.objects.filter(reporte_Departamento__in=['FAIN','UNACH','TRAB_SOC'], tipo_reporte='Induccion').order_by('nombre')   
	elif request.user.profile.permiso == '1':
